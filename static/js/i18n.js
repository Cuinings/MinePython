...
var I18N = {
    zh: {
        ...
        loading:"加载中...",login_required:"登录已失效，请重新登录",session_expired_title:"登录已失效",session_expired_msg:"您的登录状态已过期，请重新登录以继续。",relogin:"重新登录",relogin_auto:"将在 {n} 秒后自动跳转登录页",auto_tag:"🤖 自动归类",new_tag:"+ 新建",
        ...
        auto_label:"自动归类",login:"登录",register:"注册",logout:"退出",nav_files:"文件",nav_users:"用户管理",
        ...
        btn_add_user:"+ 添加用户",btn_edit:"编辑",btn_save:"保存",btn_cancel:"取消",btn_confirm:"确认",
        ...
        pw_changed_relogin:"密码已修改，请重新登录",acct_deactivated:"账号已注销",deactivated:"已注销",
        ...
        audit_clear_confirm:"确定要清空全部审计日志吗？此操作不可逆，且会记录一条「审计已清空」的留存记录。",
        audit_clear_confirm2:"再次确认：所有审计记录将被永久删除，无法恢复。",
        ...
        ucenter:"用户中心",user_info:"用户信息",settings:"设置",center_desc:"查看并管理你的账号",edit_profile:"修改资料",logout_login:"退出登陆",ui_username:"用户名",ui_nickname:"昵称",ui_role:"角色",ui_status:"状态",ui_permissions:"权限",ui_ip:"登录IP",profile_saved:"资料已更新",profile_nick_ph:"请输入昵称",settings_blank:"（设置模块开发中，敬请期待）",
        ...
        nav_suggest:"建议", suggest_title:"功能需求建议栏", suggest_all:"全部", suggest_status_pending:"待处理", suggest_status_accepted:"已采纳", suggest_status_rejected:"已拒绝", suggest_status_done:"已实现", suggest_search_ph:"搜索建议…", suggest_form:"提交新建议", suggest_title_ph:"标题", suggest_category:"分类", suggest_cat_feature:"功能新增", suggest_cat_ux:"体验优化", suggest_cat_bug:"Bug 反馈", suggest_cat_other:"其他", suggest_body:"详细描述", suggest_body_ph:"补充背景、预期效果…", suggest_submit:"提交建议", suggest_title_required:"请填写标题", suggest_submitted:"已提交，感谢你的建议", suggest_empty:"暂无建议", suggest_admin_note:"管理员备注", suggest_update_status:"更新状态", suggest_delete:"删除", suggest_delete_confirm:"确定删除这条建议吗？", suggest_updated:"状态已更新", suggest_deleted:"已删除",nav_org:"组织架构",org_title:"组织架构",org_tree:"部门",org_add_dept:"+ 新建部门",org_dept_name:"部门名称",org_parent:"上级部门",org_root:"（顶级部门）",org_sort:"排序",org_description:"描述",org_members:"成员",org_add_member:"+ 添加成员",org_member_title:"职位",org_user:"用户",org_pick_dept:"请选择左侧部门查看成员",org_empty:"暂无部门",org_no_members:"该部门暂无成员",org_edit_dept:"编辑部门",org_delete_dept:"删除部门",org_name_required:"请输入部门名称",org_saved:"已保存",org_deleted:"已删除",org_remove_member:"移除",org_confirm_delete_dept:"确定删除该部门吗？其下子部门与成员将一并删除。",org_confirm_remove_member:"确定移除该成员吗？",org_pick_dept_first:"请先选择部门",org_loading_users:"加载用户…",org_pick_user:"请选择用户",org_member_added:"已添加成员",org_member_removed:"已移除",org_search_ph:"搜索部门 / 成员…",org_one_dept_hint:"一名成员只能属于一个部门；已分配的用户会标注所在部门，选中后保存即调岗",org_in_dept:"已在",org_transfer:"调岗",org_transfer_title:"成员调岗",org_transfer_target:"目标部门",org_transferred:"已调岗",org_member_moved:"已将该成员调整到此部门",org_no_other_dept:"暂无其他部门可转入",home_greet_morning:"早上好",home_greet_noon:"中午好",home_greet_afternoon:"下午好",home_greet_evening:"晚上好",home_greet_night:"凌晨好",home_storage:"存储用量",home_stat_total:"文件总数",home_stat_mine:"我的文件",home_stat_storage:"我的存储",home_stat_pending:"待我处理",home_stat_myperms:"我的权限",home_search:"搜索",home_group_workspace:"工作区",home_group_admin:"管理后台",home_group_system:"系统 / 帮助",home_recent:"近期文件",home_no_recent:"暂无文件",home_quota_off:"配额未设置",home_pending_sub:"注册待审批 {n} 项",home_mystorage_sub:"已用 {used} / 配额 {quota}",home_view_all:"查看全部",home_mod_desc_files:"上传 / 下载 / 预览 / 批量操作",home_mod_desc_org:"部门树与成员管理",home_mod_desc_users:"账号 CRUD · 审批 · 批量创建",home_mod_desc_audit:"关键操作留痕 · 导出 CSV",home_mod_desc_settings:"站点名 · 上限 · 配额 · 限流",home_mod_desc_api:"Swagger / ReDoc 交互测试",home_mod_desc_suggest:"提需求 · 看进度",home_nav_api:"API 文档",home_skeleton:"加载中…",home_just_now:"刚刚",home_min_ago:"分钟前",home_hr_ago:"小时前",home_day_ago:"天前",home_last_login:"上次登录",
    },
    en: {
        title:"MinePython",h1:"📁 MinePython",subtitle_label:"Categories",
        loading:"Loading...",login_required:"Session expired, please log in again",session_expired_title:"Session expired",session_expired_msg:"Your session has expired. Please log in again to continue.",relogin:"Log in again",relogin_auto:"Redirecting to login in {n}s",auto_tag:"🤖 Auto",new_tag:"+ New",
        ...
        auto_label:"auto",login:"Login",register:"Register",logout:"Logout",nav_files:"Files",nav_users:"User Management",        select_all:"Select all",batch_dl:"Batch Download",batch_approve:"Batch Approve",batch_reject:"Batch Reject",
        ...
        btn_add_user:"+ Add User",btn_edit:"Edit",btn_save:"Save",btn_cancel:"Cancel",btn_confirm:"Confirm",
        ...
        pw_changed_relogin:"Password changed, please log in again",acct_deactivated:"Account deactivated",deactivated:"Deactivated",
        ...
        audit_clear_confirm:"Clear ALL audit logs? This is irreversible and a 'Audit cleared' record will be kept.",
        audit_clear_confirm2:"Confirm again: all audit records will be permanently deleted and cannot be recovered.",
        ...
        ucenter:"User Center",user_info:"User Info",settings:"Settings",center_desc:"View and manage your account",edit_profile:"Edit Profile",logout_login:"Log Out",ui_username:"Username",ui_nickname:"Nickname",ui_role:"Role",ui_status:"Status",ui_permissions:"Permissions",ui_ip:"Login IP",profile_saved:"Profile updated",profile_nick_ph:"Enter nickname",settings_blank:"(Settings module coming soon)",
        ...
        nav_suggest:"Suggestions", suggest_title:"Feature Suggestions", suggest_all:"All", suggest_status_pending:"Pending", suggest_status_accepted:"Accepted", suggest_status_rejected:"Rejected", suggest_status_done:"Done", suggest_search_ph:"Search suggestions…", suggest_form:"Submit a suggestion", suggest_title_ph:"Title", suggest_category:"Category", suggest_cat_feature:"New feature", suggest_cat_ux:"UX improvement", suggest_cat_bug:"Bug report", suggest_cat_other:"Other", suggest_body:"Details", suggest_body_ph:"Background, expected outcome…", suggest_submit:"Submit", suggest_title_required:"Please enter a title", suggest_submitted:"Submitted, thank you!",home_greet_morning:"Good morning",home_greet_noon:"Good noon",home_greet_afternoon:"Good afternoon",home_greet_evening:"Good evening",home_greet_night:"Good night",home_storage:"Storage",home_stat_total:"Total files",home_stat_mine:"My files",home_stat_storage:"My storage",home_stat_pending:"Needs attention",home_stat_myperms:"My permissions",home_search:"Search",home_group_workspace:"Workspace",home_group_admin:"Admin",home_group_system:"System / Help",home_recent:"Recent files",home_no_recent:"No files yet",home_quota_off:"No quota set",home_pending_sub:"{n} pending approvals",home_mystorage_sub:"{used} of {quota}",home_view_all:"View all",home_mod_desc_files:"Upload / download / preview / batch",home_mod_desc_org:"Dept. tree & members",home_mod_desc_users:"CRUD · approve · batch",home_mod_desc_audit:"Audit trail · export CSV",home_mod_desc_settings:"Name · limits · quota · rate",home_mod_desc_api:"Swagger / ReDoc playground",home_mod_desc_suggest:"Requests · track progress",home_nav_api:"API Docs",home_skeleton:"Loading…",home_just_now:"just now",home_min_ago:"m ago",home_hr_ago:"h ago",home_day_ago:"d ago",home_last_login:"Last login", suggest_empty:"No suggestions yet", suggest_admin_note:"Admin note", suggest_update_status:"Update status", suggest_delete:"Delete", suggest_delete_confirm:"Delete this suggestion?", suggest_updated:"Status updated", suggest_deleted:"Deleted",nav_org:"Organization",org_title:"Organization",org_tree:"Departments",org_add_dept:"+ New Dept",org_dept_name:"Department name",org_parent:"Parent",org_root:"(Top level)",org_sort:"Order",org_description:"Description",org_members:"Members",org_add_member:"+ Add Member",org_member_title:"Title",org_user:"User",org_pick_dept:"Select a department on the left",org_empty:"No departments",org_no_members:"No members in this department",org_edit_dept:"Edit department",org_delete_dept:"Delete department",org_name_required:"Please enter a department name",org_saved:"Saved",org_deleted:"Deleted",org_remove_member:"Remove",org_confirm_delete_dept:"Delete this department and its sub-departments & members?",org_confirm_remove_member:"Remove this member?",org_pick_dept_first:"Select a department first",org_loading_users:"Loading users…",org_pick_user:"Please select a user",org_member_added:"Member added",org_member_removed:"Member removed",org_search_ph:"Search departments / members…",org_one_dept_hint:"A member can belong to only one department; assigned users are labelled with their current dept and can be selected to transfer",org_in_dept:"in",org_transfer:"Transfer",org_transfer_title:"Transfer member",org_transfer_target:"Target department",org_transferred:"Transferred",org_member_moved:"Member moved to this department",org_no_other_dept:"No other department to move to",
    },
    ru: {
        title:"MinePython",h1:"📁 MinePython",subtitle_label:"Категории",
        loading:"Загрузка...",login_required:"Сессия истекла, войдите снова",session_expired_title:"Сессия истекла",session_expired_msg:"Ваша сессия истекла. Войдите снова, чтобы продолжить.",relogin:"Войти снова",relogin_auto:"Переход к входу через {n} с",auto_tag:"🤖 Авто",new_tag:"+ Новый",
        ...
        auto_label:"авто",login:"Войти",register:"Регистрация",logout:"Выйти",nav_files:"Файлы",nav_users:"Управление пользователями",        select_all:"Выбрать все",batch_dl:"Скачать всё",batch_approve:"Пакетное одобр.",batch_reject:"Пакетное откл.",
        ...
        btn_add_user:"+ Добавить",btn_edit:"Ред.",btn_save:"Сохранить",btn_cancel:"Отмена",btn_confirm:"Подтвердить",
        ...
        pw_changed_relogin:"Пароль изменён, войдите снова",acct_deactivated:"Аккаунт удалён",deactivated:"Деактивирован",
        ...
        audit_clear_confirm:"Очистить ВЕСЬ журнал аудита? Необратимо, запись 'Аудит очищен' сохранится.",
        audit_clear_confirm2:"Подтвердите ещё раз: все записи будут удалены навсегда.",
        ...
        nav_suggest:"Предложения", suggest_title:"Предложения по функциям", suggest_all:"Все", suggest_status_pending:"Ожидание", suggest_status_accepted:"Принято", suggest_status_rejected:"Отклонено", suggest_status_done:"Готово", suggest_search_ph:"Поиск предложений…", suggest_form:"Отправить предложение", suggest_title_ph:"Заголовок", suggest_category:"Категория", suggest_cat_feature:"Новая функция", suggest_cat_ux:"Улучшение UX", suggest_cat_bug:"Ошибка", suggest_cat_other:"Другое", suggest_body:"Описание", suggest_body_ph:"Контекст, ожидаемый результат…", suggest_submit:"Отправить", suggest_title_required:"Введите заголовок", suggest_submitted:"Отправлено, спасибо!",home_greet_morning:"Доброе утро",home_greet_noon:"Добрый день",home_greet_afternoon:"Добрый день",home_greet_evening:"Добрый вечер",home_greet_night:"Доброй ночи",home_storage:"Хранилище",home_stat_total:"Всего файлов",home_stat_mine:"Мои файлы",home_stat_storage:"Моё хранилище",home_stat_pending:"Требует внимания",home_stat_myperms:"Мои права",home_search:"Поиск",home_group_workspace:"Рабочая зона",home_group_admin:"Админ-панель",home_group_system:"Система / Помощь",home_recent:"Недавние файлы",home_no_recent:"Файлов пока нет",home_quota_off:"Лимит не задан",home_pending_sub:"{n} на одобрении",home_mystorage_sub:"{used} из {quota}",home_view_all:"Все",home_mod_desc_files:"Загрузка / скачивание / просмотр",home_mod_desc_org:"Дерево отделов и участники",home_mod_desc_users:"CRUD · одобрение · пакет",home_mod_desc_audit:"Журнал аудита · CSV",home_mod_desc_settings:"Имя · лимиты · квота",home_mod_desc_api:"Swagger / ReDoc",home_mod_desc_suggest:"Идеи · статус",home_nav_api:"API Docs",home_skeleton:"Загрузка…",home_just_now:"только что",home_min_ago:"мин назад",home_hr_ago:"ч назад",home_day_ago:"дн назад",home_last_login:"Последний вход", suggest_empty:"Пока нет предложений", suggest_admin_note:"Заметка админа", suggest_update_status:"Обновить статус", suggest_delete:"Удалить", suggest_delete_confirm:"Удалить это предложение?", suggest_updated:"Статус обновлён", suggest_deleted:"Удалено",nav_org:"Организация",org_title:"Организация",org_tree:"Отделы",org_add_dept:"+ Новый отдел",org_dept_name:"Название отдела",org_parent:"Родитель",org_root:"(Верхний уровень)",org_sort:"Порядок",org_description:"Описание",org_members:"Участники",org_add_member:"+ Добавить",org_member_title:"Должность",org_user:"Пользователь",org_pick_dept:"Выберите отдел слева",org_empty:"Нет отделов",org_no_members:"В этом отделе нет участников",org_edit_dept:"Изменить отдел",org_delete_dept:"Удалить отдел",org_name_required:"Введите название отдела",org_saved:"Сохранено",org_deleted:"Удалено",org_remove_member:"Удалить",org_confirm_delete_dept:"Удалить отдел и все вложенные отделы и участники?",org_confirm_remove_member:"Удалить этого участника?",org_pick_dept_first:"Сначала выберите отдел",org_loading_users:"Загрузка пользователей…",org_pick_user:"Выберите пользователя",org_member_added:"Участник добавлен",org_member_removed:"Участник удалён",org_search_ph:"Поиск отделов / участников…",org_one_dept_hint:"Участник может состоять только в одном отделе; назначенные пользователи отмечены текущим отделом и доступны для перевода",org_in_dept:"в",org_transfer:"Перевод",org_transfer_title:"Перевод участника",org_transfer_target:"Целевой отдел",org_transferred:"Переведён",org_member_moved:"Участник перемещён в этот отдел",org_no_other_dept:"Нет другого отдела для перевода",
    }
};
...
function switchToLang(code) {
    if (lang === code) { var m = document.getElementById('langMenu'); if (m) { m.classList.remove('show'); var b = document.getElementById('langBtn'); if (b) b.setAttribute('aria-expanded', 'false'); } return; }
    lang = code;
...
function updateLangBtn() {
    var btn = document.getElementById('langBtn');
    if (btn) {
        // The language-switch entry must always display the CURRENT language.
        // Show the full language name (e.g. 中文 / English / Русский) so it is
        // unambiguous, prefixed with a globe to signal it is the language control.
        var name = LANG_NAMES[lang] || lang;
        btn.textContent = '🌐 ' + name;
        btn.setAttribute('aria-label', '语言: ' + name);
